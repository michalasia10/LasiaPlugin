...
class LasiaPlugin:
    ...
    def initGui(self) -> None:
        ...
        :return: None
        """
        self.action, self.menu = self._add_action(":/plugins/LasiaPlugin/icon.png", "LasiaPlugin", "Menu LasiaPlugin")
    ...
    def _open(self)->None:
        """
        Metoda odpowiada za otworzenie okna z folderami w celu wyszukania pliku, po dodaniu warstwa jest w układzie 2177

        """
        crs = QgsCoordinateReferenceSystem(2177)
    ...
    def _count_standard_deviation(self):
        ...
        self._sigmoid = math.sqrt(meanSquare)
    ...
    def _check_is_any_active_layer(self)->bool:
        ...
        if not layerList:
            self.iface.messageBar().pushMessage("ERROR", "Brak warstwy z obiektami", level=Qgis.Critical, duration=3)
            return True
        return False
    ...
    def run(self)->None:
        ...
        self.form.pushButton.clicked.connect(self._plot_barChart)
